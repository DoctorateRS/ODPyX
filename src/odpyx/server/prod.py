...
def prodNetworkConfig():
    ...
    if server_config["assets"]["autoUpdate"]:
        match mode:
            case "cn":
                version = update_data("https://ak-conf.hypergryph.com/config/prod/official/Android/version")
                server_config["version"]["android"] = version
            case "global":
                version = update_data("https://ark-us-static-online.yo-star.com/assetbundle/official/Android/version")
...
def prodPreAnnouncement():
    ...
    match mode:
        case "cn":
            data = update_data("https://ak-conf.hypergryph.com/config/prod/announce_meta/Android/preannouncement.meta.json")
        case "global":
            data = update_data("https://ark-us-static-online.yo-star.com/announce/Android/preannouncement.meta.json")
        case _:
            data = update_data("https://ak-conf.hypergryph.com/config/prod/announce_meta/Android/preannouncement.meta.json")
...
def prodAnnouncement():
    ...
    match mode:
        case "cn":
            data = update_data("https://ak-conf.hypergryph.com/config/prod/announce_meta/Android/announcement.meta.json")
        case "global":
            data = update_data("https://ark-us-static-online.yo-star.com/announce/Android/announcement.meta.json")
        case _:
            data = update_data("https://ak-conf.hypergryph.com/config/prod/announce_meta/Android/announcement.meta.json")
