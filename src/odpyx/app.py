...
app.add_url_rule(
    "/aprilFool/act5fun/battleStart", methods=["POST"], view_func=quest.questBattleStart
)
app.add_url_rule(
...
app.add_url_rule(
    "/aprilFool/act4fun/battleStart", methods=["POST"], view_func=quest.questBattleStart
)
app.add_url_rule(
...
app.add_url_rule(
    "/aprilFool/act3fun/battleStart", methods=["POST"], view_func=quest.questBattleStart
)
app.add_url_rule(
...
app.add_url_rule(
    "/account/syncData", methods=["POST"], view_func=account.accountSyncData
)
app.add_url_rule(
    "/account/syncStatus", methods=["POST"], view_func=account.accountSyncStatus
)
app.add_url_rule(
...
app.add_url_rule(
    "/building/assignChar", methods=["POST"], view_func=building.building_assignChar
)
app.add_url_rule(
...
app.add_url_rule(
    "/char/changeMarkStar", methods=["POST"], view_func=char.charChangeMarkStar
)
...
app.add_url_rule(
    "/crisis/getInfo", methods=["POST"], view_func=crisis.crisisGetCrisisInfo
)
app.add_url_rule(
    "/crisis/battleStart", methods=["POST"], view_func=crisis.crisisBattleStart
)
app.add_url_rule(
    "/crisis/battleFinish", methods=["POST"], view_func=crisis.crisisBattleFinish
)

app.add_url_rule(
    "/crisisV2/getInfo", methods=["POST"], view_func=crisis.crisisV2_getInfo
)
app.add_url_rule(
    "/crisisV2/battleStart", methods=["POST"], view_func=crisis.crisisV2_battleStart
)
app.add_url_rule(
    "/crisisV2/battleFinish", methods=["POST"], view_func=crisis.crisisV2_battleFinish
)
app.add_url_rule(
    "/crisisV2/getSnapshot", methods=["POST"], view_func=crisis.crisisV2_getSnapshot
)
...
app.add_url_rule(
    "/mail/getMetaInfoList", methods=["POST"], view_func=mail.mailGetMetaInfoList
)
...
app.add_url_rule(
    "/mail/receiveAllMail", methods=["POST"], view_func=mail.mailReceiveAllMail
)
app.add_url_rule(
...
app.add_url_rule(
    "/online/v1/loginout", methods=["POST"], view_func=online.onlineV1LoginOut
)

app.add_url_rule("/tower/createGame", methods=["POST"], view_func=tower.towerCreateGame)
app.add_url_rule(
    "/tower/initGodCard", methods=["POST"], view_func=tower.towerInitGodCard
)
...
app.add_url_rule(
    "/tower/battleStart", methods=["POST"], view_func=tower.towerBattleStart
)
app.add_url_rule(
    "/tower/battleFinish", methods=["POST"], view_func=tower.towerBattleFinish
)
app.add_url_rule("/tower/recruit", methods=["POST"], view_func=tower.towerRecruit)
app.add_url_rule(
    "/tower/chooseSubGodCard", methods=["POST"], view_func=tower.towerChooseSubGodCard
)
...
app.add_url_rule(
    "/u8/pay/getAllProductList", methods=["POST"], view_func=pay.paygetAllProductList
)

app.add_url_rule(
    "/quest/battleStart", methods=["POST"], view_func=quest.questBattleStart
)
app.add_url_rule(
    "/quest/battleFinish", methods=["POST"], view_func=quest.questBattleFinish
)
app.add_url_rule(
    "/quest/saveBattleReplay", methods=["POST"], view_func=quest.questSaveBattleReplay
)
app.add_url_rule(
    "/quest/getBattleReplay", methods=["POST"], view_func=quest.questGetBattleReplay
)
app.add_url_rule(
    "/quest/changeSquadName", methods=["POST"], view_func=quest.questChangeSquadName
)
app.add_url_rule(
    "/quest/squadFormation", methods=["POST"], view_func=quest.questSquadFormation
)
app.add_url_rule(
    "/quest/getAssistList", methods=["POST"], view_func=quest.questGetAssistList
)

app.add_url_rule(
    "/quest/battleContinue", methods=["POST"], view_func=quest.questBattleContinue
)
...
app.add_url_rule(
    "/act25side/battleStart", methods=["POST"], view_func=quest.questBattleStart
)
app.add_url_rule(
    "/act25side/battleFinish", methods=["POST"], view_func=quest.questBattleFinish
)

app.add_url_rule(
    "/car/confirmBattleCar", methods=["POST"], view_func=quest.confirmBattleCar
)

app.add_url_rule(
    "/templateTrap/setTrapSquad", methods=["POST"], view_func=quest.setTrapSquad
)
...
app.add_url_rule(
    "/activity/act24side/setTool", methods=["POST"], view_func=quest.setTool
)

app.add_url_rule(
    "/activity/bossRush/battleStart", methods=["POST"], view_func=quest.questBattleStart
)
app.add_url_rule(
...
app.add_url_rule(
    "/activity/bossRush/relicSelect", methods=["POST"], view_func=quest.relicSelect
)
...
app.add_url_rule(
    "/rlv2/chooseInitialRelic", methods=["POST"], view_func=rlv2.rlv2ChooseInitialRelic
)
app.add_url_rule(
    "/rlv2/selectChoice", methods=["POST"], view_func=rlv2.rlv2SelectChoice
)
app.add_url_rule(
...
app.add_url_rule(
    "/rlv2/closeRecruitTicket", methods=["POST"], view_func=rlv2.rlv2CloseRecruitTicket
)
app.add_url_rule("/rlv2/finishEvent", methods=["POST"], view_func=rlv2.rlv2FinishEvent)
app.add_url_rule(
    "/rlv2/moveAndBattleStart", methods=["POST"], view_func=rlv2.rlv2MoveAndBattleStart
)
app.add_url_rule(
    "/rlv2/battleFinish", methods=["POST"], view_func=rlv2.rlv2BattleFinish
)
app.add_url_rule(
    "/rlv2/finishBattleReward", methods=["POST"], view_func=rlv2.rlv2FinishBattleReward
)
...
app.add_url_rule(
    "/rlv2/chooseBattleReward", methods=["POST"], view_func=rlv2.rlv2ChooseBattleReward
)

app.add_url_rule(
    "/shop/getSkinGoodList", methods=["POST"], view_func=shop.shopGetSkinGoodList
)

app.add_url_rule(
    "/story/finishStory", methods=["POST"], view_func=story.storyFinishStory
)
app.add_url_rule(
    "/quest/finishStoryStage", methods=["POST"], view_func=story.storyFinishStory
)
...
app.add_url_rule(
    "/user/changeSecretary", methods=["POST"], view_func=user.userChangeSecretary
)
app.add_url_rule("/user/login", methods=["POST"], view_func=user.userLogin)
app.add_url_rule(
    "/user/changeAvatar", methods=["POST"], view_func=user.userChangeAvatar
)
app.add_url_rule(
    "/user/oauth2/v1/grant", methods=["POST"], view_func=user.userOAuth2V1Grant
)
app.add_url_rule(
...
app.add_url_rule(
    "/user/yostar_createlogin", methods=["POST"], view_func=user.userYostarCreatelogin
)
app.add_url_rule(
    "/u8/user/v1/getToken", methods=["POST"], view_func=user.userV1getToken
)

app.add_url_rule(
    "/user/changeResume", methods=["POST"], view_func=user.user_changeResume
)
app.add_url_rule(
    "/social/getSortListInfo", methods=["POST"], view_func=user.social_getSortListInfo
)
app.add_url_rule(
    "/social/searchPlayer", methods=["POST"], view_func=user.social_searchPlayer
)
app.add_url_rule(
...
app.add_url_rule(
    "/social/setCardShowMedal", methods=["POST"], view_func=user.social_setCardShowMedal
)
app.add_url_rule(
    "/medal/setCustomData", methods=["POST"], view_func=user.medal_setCustomData
)
...
app.add_url_rule(
    "/sandboxPerm/sandboxV2/createGame", methods=["POST"], view_func=sandbox.createGame
)
app.add_url_rule(
...
app.add_url_rule(
    "/sandboxPerm/sandboxV2/setSquad", methods=["POST"], view_func=sandbox.setSquad
)
app.add_url_rule(
...
app.add_url_rule(
    "/sandboxPerm/sandboxV2/settleGame", methods=["POST"], view_func=sandbox.settleGame
)
app.add_url_rule(
    "/sandboxPerm/sandboxV2/eatFood", methods=["POST"], view_func=sandbox.eatFood
)
app.add_url_rule(
...
app.add_url_rule(
    "/gacha/boostNormalGacha", methods=["POST"], view_func=gacha.boostNormalGacha
)
app.add_url_rule(
    "/gacha/finishNormalGacha", methods=["POST"], view_func=gacha.finishNormalGacha
)
app.add_url_rule(
    "/gacha/syncNormalGacha", methods=["POST"], view_func=gacha.syncNormalGacha
)
app.add_url_rule(
    "/gacha/getPoolDetail", methods=["POST"], view_func=gacha.getPoolDetail
)
app.add_url_rule(
    "/gacha/advancedGacha", methods=["POST"], view_func=gacha.advancedGacha
)
app.add_url_rule(
    "/gacha/tenAdvancedGacha", methods=["POST"], view_func=gacha.tenAdvancedGacha
)
...
app.add_url_rule(
    "/user/oauth2/v2/grant", methods=["POST"], view_func=user.oauth2_v2_grant
)
app.add_url_rule("/app/v1/config", methods=["GET"], view_func=user.app_v1_config)
app.add_url_rule(
    "/general/v1/server_time", methods=["GET"], view_func=user.general_v1_server_time
)
