...
from ..const import TOWERDATA_PATH, TOWER_TABLE_URL, USER_JSON_PATH
from .util import read_json, write_json, decrypt_battle_data, update_data, time


TOWER_TABLE = update_data(TOWER_TABLE_URL)
...
def towerCreateGame():
    ...
    data = {
        "playerDataDelta": {
            "modified": {"tower": read_json(TOWERDATA_PATH)["tower"]},
            "deleted": {},
        }
    }
