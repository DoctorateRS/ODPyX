...
from ..const import SANDBOX_JSON_PATH, SANDBOX_TEMP_JSON_PATH, SANDBOX_TABLE_URL
            ...
            "SANDBOX_V2": {
                "sandbox_1": {
                    ...
                    "main": {
                        ...
                        "map": {
                            "season": {"type": 0, "remain": 18, "total": 18},
                            "zone": {
                                "z_1_2": {"state": 1, "weather": 0},
                                "z_1_4": {"state": 1, "weather": 0},
                                "z_1_3": {"state": 1, "weather": 0},
                                "z_1_1": {"state": 1, "weather": 0},
                                "z_1_0": {"state": 1, "weather": 0},
                            },
                            "node": {
                                "nB32E": {
                                    "zone": "z_1_0",
                                ...
                                "nA659": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [-1970.00012, -997.3706],
                                        "adj": ["n0446", "nED84", "n8375"],
                                        "depth": 8,
                                    },
                                ...
                                "nED84": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [-1834.99988, -772.000061],
                                        "adj": ["nA659", "nA226", "nEFA5", "nD54F"],
                                        "depth": 7,
                                    },
                                ...
                                "nD7CE": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [229.000015, -248.000031],
                                        "adj": ["n2D12", "n6368", "n9096"],
                                        "depth": 2,
                                    },
                                ...
                                "n3809": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [-1019.38336, -1481.50134],
                                        "adj": ["nEA6F", "nE095", "n4B29", "n71D1"],
                                        "depth": 12,
                                    },
                                ...
                                "nC69C": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [-251.683289, -1795.38708],
                                        "adj": ["n0FB8", "n9C6A", "nF5F6", "n71D1"],
                                        "depth": 14,
                                    },
                                    "stageId": "sandbox_1_69",
                                    "weatherLv": 0,
                                ...
                                "n1AA7": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [1897.44946, -231.493286],
                                        "adj": ["n9AE0", "nDFEC", "nE57A"],
                                        "depth": 24,
                                    },
                                ...
                                "nE57A": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [1529.31409, -63.9588356],
                                        "adj": ["n1AA7", "nA317", "n403F"],
                                        "depth": 23,
                                    },
                                    "stageId": "sandbox_1_73",
                                    "weatherLv": 0,
                                ...
                                "n6B1D": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [938.534058, 308.5852],
                                        "adj": ["n7F77", "n4A25", "nA6A1"],
                                        "depth": 22,
                                    },
                                    "stageId": "sandbox_1_45",
                                    "weatherLv": 0,
                                ...
                                "n4A25": {
                                    ...
                                    "state": 2,
                                    "relate": {
                                        "pos": [1284.62524, 581.9311],
                                        "adj": ["n6828", "n6B1D", "nA6A1"],
                                        "depth": 23,
                                    },
                    ...
                    "cook": {
                        ...
                        "food": {
                            "f_1": {
                                "id": "sandbox_1_food_0",
                                "sub": ["sandbox_1_condiment", "sandbox_1_condiment"],
                                "count": 9999,
                            },
                            "f_2": {
                                "id": "sandbox_1_food_1",
...
def battleFinish():
    ...
    data = {
        ...
        "isEnemyRush": False,
        "enemyRushCount": [],
        "playerDataDelta": {"modified": {"sandboxPerm": sandbox}, "deleted": {}},
    }
...
def monthBattleFinish():
    ...
    for i in request_json["sandboxV2Data"]["placedItems"]:
        if i["value"]["hpRatio"]:
            sandbox["template"]["SANDBOX_V2"]["sandbox_1"]["main"]["stage"]["node"][node_id]["building"].append({"key": i["key"]["itemId"], "pos": [i["key"]["position"]["row"], i["key"]["position"]["col"]], "hpRatio": 10000, "dir": i["value"]["direction"]})
        else:
            for j in range(len(sandbox["template"]["SANDBOX_V2"]["sandbox_1"]["main"]["stage"]["node"][node_id]["building"])):
                k = sandbox["template"]["SANDBOX_V2"]["sandbox_1"]["main"]["stage"]["node"][node_id]["building"][j]
                if k["pos"][0] == i["key"]["position"]["row"] and k["pos"][1] == i["key"]["position"]["col"]:
    ...
    write_json(sandbox, SANDBOX_JSON_PATH)
    return {"success": True, "firstPass": False, "enemyRushCount": [0, 0], "playerDataDelta": {"modified": {"sandboxPerm": sandbox}, "deleted": {}}}
...
def exploreMode():
    ...
    return {"playerDataDelta": {"modified": {"sandboxPerm": sandbox}, "deleted": {}}}
