...
from ..const import MAILLIST_PATH
...
def mailGetMetaInfoList():
    ...
    data = {"result": result, "playerDataDelta": {"modified": {}, "deleted": {}}}
...
def mailListMailBox():
    ...
    data = {
        "mailList": mails,
        "playerDataDelta": {
            "modified": {"pushFlags": {"hasGifts": hasGift}},
            "deleted": {},
        },
    }
